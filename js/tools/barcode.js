...
com.logicpartners.designerTools.barcode = function() {
	var self = this;
	this.counter = 1;
	this.button = $("<div></div>").addClass("designerToolbarBarcode designerToolbarButton").attr("title", "Barcode - Code 39").append($("<div></div>"));
	this.object = function(x, y, width, height, barcodeTitle) {
		...
		this.GetElementType=function() {return "barcode";}
	}
};